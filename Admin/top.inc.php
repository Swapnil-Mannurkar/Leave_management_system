        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse" style="margin-top:60px;">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="leave_type.php"> Leave type list</a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="index.php"> Department list</a>
                    </li>
                    <li class="menu-item-has-children dropdown">
        ...
        <header id="header" class="header" style="padding-bottom: 100px;">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php" style="margin-left: 40px;"><img src="assets/img/logo.jpg" width="80px" height="80px"></a>
